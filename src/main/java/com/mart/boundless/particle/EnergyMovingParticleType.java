...
public class EnergyMovingParticleType extends ParticleType<EnergyParticleData> {


    public EnergyMovingParticleType() {
    ...
    public static class MovingFactory implements IParticleFactory<EnergyParticleData>
    {

        private final IAnimatedSprite sprite;

        public MovingFactory(IAnimatedSprite sprite) {
            this.sprite = sprite;
        }
        ...
        {
            EnergyMovingParticle base = new EnergyMovingParticle(colorData, worldIn, x, y, z, xSpeed, ySpeed, zSpeed);
